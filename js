...
$(document).ready(function () {
    $('div[id$="_div"]').each(function () {
		...
		// Amount fields ,Add your Currency and amount fields respectively
			...
			const amountFields = [
				 { ccy: 'INV_CCY', amt: 'INV_AMT'},
				/*{ ccy: 'PCFC_OTHER_CCY', amt: 'UNDER_AMT'} */
...
wrapErrorRows();
	...
	const sections = [
        ...
        { id: 'PartiesTab', number: 1, title: 'Parties', tickId: 'tick1', numberId: 'number1', divid: '1_div' },
        { id: 'OdiDetailsTab', number: 2, title: 'ODI Details', tickId: 'tick2', numberId: 'number2', divid: '2_div' },
        { id: 'Section_Btab', number: 3, title: 'Section B', tickId: 'tick3', numberId: 'number3', divid: '3_div' },
		{ id: 'undertakings', number: 4, title: 'Undertakings', tickId: 'tick4', numberId: 'number4', divid: '4_div' },
		{ id: 'DocumentsUpload', number: 5, title: 'Documents Upload', tickId: 'tick5', numberId: 'number5', divid: '5_div' },
		{ id: 'CommunicationTab', number: 6, title: 'Communication', tickId: 'tick6', numberId: 'number6', divid: '6_div' }
	...
	function initializeStepper() {
        ...
        const useExistingTemplate = $('<span>', { class: 'use-existing-template', text: 'Use Existing Template' ,onclick:'template_Disbursal()' });
    ...
    function renderTrxSysBtnsDiv1() {
        ...
        var $cancelButton = $('<input>', {
            ...
            click: function () {
               // CancelTransaction();
			   getFuncIdOnClick_n('F05030701680')
            }
        });
        ...
        $trxSysBtnsDiv.append($saveButton, $createTemplateButton, $cancelButton, $nextButton, $submitButton);
...
if(SYS_FUNCTION_TYPE == "RE"){
    ...
    setTimeout(() => {
        if (sSelectedFuncId == "F05030701031") {
            updateButtonStyles('viewLCButton1', ['unlockLCButton', 'authLCButton']);
